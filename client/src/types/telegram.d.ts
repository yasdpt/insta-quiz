...
interface WebApp {
   ...
   */
  requestWriteAccess(callback?: (accepted: boolean) => void): void;
  /**
   * A method that shows a native popup prompting the user for their phone number.
   * If an optional callback parameter was passed, the callback function will be called when the popup
   * is closed and the first argument will be a boolean indicating whether the user shared its phone number.
   */
...
interface CloudStorage {
  ...
  getItems(
    keys: string[],
    callback: (error: string | null, values?: string[]) => void
  ): void;
   ...
   * If an optional callback parameter was passed, the callback function will be called.
   * In case of an error, the first argument will contain the error.
   * In case of success, the first argument will be null and the second argument will be
   * a boolean indicating whether the value was removed.
   */
  removeItem(
    key: string,
    callback?: (error: string | null, success?: boolean) => void
   ...
   * In case of an error, the first argument will contain the error.
   * In case of success, the first argument will be null and the second argument will be
   * a boolean indicating whether the values were removed.
   */
  removeItems(
    keys: string[],
    callback?: (error: string | null, success?: boolean) => void
   ...
   * In case of success, the first argument will be null and the list of keys
